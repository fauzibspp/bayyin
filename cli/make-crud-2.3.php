...
$columnHeaders = '';
$columnsJs = '';
$actionButtons = "'<a href=\"/{$viewFolder}/show?id=' + row.id + '\" class=\"btn btn-info btn-sm mr-1\">View</a>' + " .
                 "'<a href=\"/{$viewFolder}/edit?id=' + row.id + '\" class=\"btn btn-warning btn-sm mr-1\">Edit</a>' + " .
                 "'<a href=\"/{$viewFolder}/delete?id=' + row.id + '\" class=\"btn btn-danger btn-sm btn-delete\">Delete</a>'";
...
<script>
$(function () {
    $('#datatable-{$viewFolder}').DataTable({
        processing: true,
        serverSide: true,
...
Console::line("- Features: DataTables-ready index, delete confirmation, flash/validation placeholders");
