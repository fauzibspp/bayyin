    ...
    <div class="card-body">
        <form method="POST" action="/<?= htmlspecialchars($viewPath) ?>/edit">
            ...
            <div class="form-group">
                ...
                <input type="number" name="amount" id="amount" value="<?= htmlspecialchars((string) ($data['amount'] ?? '')) ?>" class="form-control" step="0.01" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="remarks" id="remarks" class="form-control" rows="4" required><?= htmlspecialchars((string) ($data['remarks'] ?? '')) ?></textarea>
            </div>
